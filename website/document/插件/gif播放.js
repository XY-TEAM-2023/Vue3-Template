!(function (t) {
    ...
    (r(15).inspectSource = function (t) {
      ...
      (t.exports = function (t, n, r, u) {
        ...
        s && (i(r, "name") || o(r, "name", n)),
          t[n] !== r &&
            (s && (i(r, a) || o(r, a, t[n] ? "" + t[n] : c.join(String(n)))),
            t === e
              ? (t[n] = r)
              : u
              ? t[n]
    ...
    (s || f) &&
      (c = function (t) {
        ...
        return (
          ...
          s && (n = c.lastIndex),
          (e = a.call(c, t)),
          s && e && (c.lastIndex = c.global ? e.index + e[0].length : n),
          f &&
            e &&
            e.length > 1 &&
      ...
      var e = r(16),
        ...
        Lt = function (t) {
          var n,
            ...
            h = O(u);
          if (null != h && !E(h)) {
            for (a = h.call(u), e = [], n = 0; !(i = a.next()).done; n++)
              e.push(i.value);
            u = e;
          }
          for (
        ...
        Ct = {
          ...
          reverse: function () {
            for (
              var t, n = St(this).length, r = Math.floor(n / 2), e = 0;
              e < r;
        ...
        Ut = function (t, n, r) {
          return !(Nt(t, (n = m(n, !0))) && b(r) && w(r, "value")) ||
            w(r, "get") ||
            w(r, "set") ||
            r.configurable ||
        ...
        (t.exports = function (t, n, r, c) {
          ...
          w
            ? ((v = r(function (t, r, e, o) {
                ...
                if (b(r)) {
                  if (
                    ...
                    return wt in r ? jt(v, r) : Lt.call(v, r);
                  (i = r), (p = kt(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (
                  h(t, "_d", { b: i, o: p, l: a, e: u, v: new q(i) });
                  l < u;
            ...
            : (i(function () {
              ...
              K(
                m !== Function.prototype ? I(y).concat(I(m)) : I(y),
                function (t) {
                  t in v || h(v, t, y[t]);
                }
              ),
          ...
          h(v, gt, !0),
            ...
            a(a.P, s, Ct),
            M(s),
            a(a.P + a.F * Et, s, { set: Mt }),
            a(a.P + a.F * !A, s, Bt),
            e || E.toString == ht || (E.toString = ht),
            a(
              a.P +
                a.F *
                  i(function () {
  ...
  function (t, n, r) {
    ...
    function e(t, n, r, e) {
      for (
        ...
        for (; f < 16 && 0 !== p; )
          (l |= t[n++] << f), (f += 8), 1 === p ? (p = t[n++]) : --p;
        if (f < c) break;
        var g = l & s;
        if (((l >>= c), (f -= c), g !== i)) {
          if (g === a) break;
          for (var y = g < u ? g : d, m = 0, w = y; w > i; )
            (w = v[w] >> 8), ++m;
          var x = w;
          if (h + m + (y !== g ? 1 : 0) > e)
          ...
          null !== d &&
            u < 4096 &&
            ((v[u++] = (d << 8) | x),
            u >= s + 1 && c < 12 && (++c, (s = (s << 1) | 1))),
            (d = g);
        } else (u = a + 1), (s = (1 << (c = o + 1)) - 1), (d = null);
      }
      return (
        h !== e && console.log("Warning, gif stream shorter than expected."), r
      );
    }
    try {
      (n.GifWriter = function (t, n, r, e) {
        ...
        (this.addFrame = function (n, r, e, i, c, s) {
          ...
          var y = !1,
            m = 0;
          if (
            void 0 !== s.transparent &&
            null !== s.transparent &&
            ((y = !0), (m = s.transparent) < 0 || m >= h)
          )
        ...
        (n.GifReader = function (t) {
          ...
          var f = !0,
            ...
            v = 0,
            d = null;
          for (this.width = r, this.height = o; f && n < t.length; )
            switch (t[n++]) {
              case 33:
                switch (t[n++]) {
                  case 255:
              ...
              default:
                throw new Error(
                  "Unknown gif block: 0x" + t[n - 1].toString(16)
                );
            }
        ...
        [
          ...
          function (t, n) {
            ...
            for (var x = 0, b = 0, _ = []; b < h.length; ) {
              ...
              if (
                null === k ||
                (E = l(u(m.lastIndex + (p ? 0 : b)), h.length)) === x
              )
                b = a(h, b, g);
              else {
  ...
  function (t, n, r) {
    "use strict";
    var e = r(31);
    r(7)({ target: "RegExp", proto: !0, forced: e !== /./.exec }, { exec: e });
  },
  function (t, n, r) {
      ...
      return [
        ...
        function (t, n) {
          ...
          for (var x, b = "", _ = 0, E = 0; E < m.length; E++) {
            ...
            for (
              var k = String(w[0]),
                S = s(f(a(w.index), h.length), 0),
                I = [],
                O = 1;
              O < w.length;
              O++
            )
              I.push(void 0 === (x = w[O]) ? x : String(x));
            var j = w.groups;
            if (p) {
  ...
  function (t, n, r) {
    var e = r(7);
    e(e.P, "Array", { fill: r(35) }), r(36)("fill");
  },
  function (t, n, r) {
    var e = r(7);
  ...
  function (t, n, r) {
    ...
    t.exports =
      ...
      r(9)(function () {
        ...
        ? function (t, n) {
            for (
              var r = u(t), s = arguments.length, f = 1, l = i.f, h = a.f;
              s > f;
      ...
      function (t, n, r, l, h) {
        ...
        if (i(y)) {
          for (p = u(t.length); p > w; w++)
            if ((g = n ? m(a((v = t[w]))[0], v[1]) : m(t[w])) === s || g === f)
              return g;
        } else
  ...
  function (t, n, r) {
    ...
    function V(t, n, r, e, o, i) {
      ...
      for (var u = t[F]._b, c = a + t[T], s = e(+o), f = 0; f < n; f++)
        u[c + f] = s[i ? f : n - f - 1];
    }
    if (a.ABV) {
      if (
  ...
  function (t, n, r) {
    ...
    t.exports = r(5)
      ...
      : function (t, n) {
          o(t);
          for (var r, a = i(n), u = a.length, c = 0; u > c; )
            e.f(t, (r = a[c++]), n[r]);
          return t;
        };
  },
    ...
    t.exports = function (t, n, r, v, d, g, y) {
      ...
      if (
        (A &&
          ...
          x.next &&
          (s(x, _, !0), e || "function" == typeof x[l] || a(x, l, p)),
        E &&
          I &&
          "values" !== I.name &&
          ((k = !0),
  ...
  function (t, n, r) {
    ...
    r(4)(a, r(0)("iterator"), function () {
      ...
      (t.exports = function (t, n, r) {
        (t.prototype = e(a, { next: o(1, r) })), i(t, n + " Iterator");
      });
  },
  function (t, n, r) {
    "use strict";
  ...
  function (t, n, r) {
    ...
    var i = (function () {
      function t(n) {
        ...
        !(function (t, n) {
          ...
          (this.frames = (function (t, n) {
            var r;
            return function () {
              r = [];
              for (
                var n = 0, e = t.numFrames();
                0 <= e ? n < e : n > e;
                0 <= e ? n++ : n--
              )
                r.push(n);
              ...
              .map(function (n) {
                var r;
                return (
                  ((r = t.frameInfo(n)).pixels = new Uint8ClampedArray(
                    t.width * t.height * 4
                  )),
                  t.decodeAndBlitFrameRGBA(n, r.pixels),
                  r
                );
              });
          })(this.reader)),
        ...
        (r = [
          ...
          },
          {
            ...
            value: function () {
              var t, n;
              return (
                (t = this.frames[this.frameIndex]),
                null != (n = this.onFrame) &&
                  n.apply(this, [t, this.frameIndex]),
            ...
            value: function () {
              (this.frameIndex += 1),
                this.frameIndex >= this.frames.length &&
                  (0 !== this.loopCount && this.loopCount === this.loops
                    ? this.stop()
                    : ((this.frameIndex = 0), (this.loops += 1)));
            },
          },
          {
            ...
            value: function () {
              ...
              for (this.advanceFrame(); this.running; ) {
                if (
                  ((r = this.frames[this.frameIndex]),
                  (n = new Date().valueOf() - this.lastTime),
                  (this.lastTime += n),
                  (this.delayCompensation += n),
                  (t = (e = 10 * r.delay) - this.delayCompensation),
                  (this.delayCompensation -= e),
                  !(t < 0))
                ) {
            ...
            value: function (t, n) {
              ...
              return (
                ...
                n &&
                  ...
                  (t.parentNode.style.width = this.width + "px"),
                  (t.parentNode.style.height = this.height + "px")),
                (r = t.getContext("2d")),
                null == this.onDrawFrame &&
                  (this.onDrawFrame = function (t, n, r) {
                        ...
                        (null == n.buffer &&
                          (n.buffer = (function (t, n, r) {
                            ...
                            return (
                              ...
                              (e.width = t.width),
                              (e.height = t.height),
                              (i = o.createImageData(n, r)).data.set(t.pixels),
                              o.putImageData(i, -t.x, -t.y),
                              e
                            );
                          })(n, e.width, e.height)),
                        "function" == typeof e.disposeFrame && e.disposeFrame(),
                        n.disposal)
                      ) {
                        case 2:
                          ...
                          break;
                        case 3:
                          (a = r.getImageData(0, 0, t.width, t.height)),
                            (e.disposeFrame = function () {
          ...
          (r = [
            {
              key: "load",
              value:
                ((c = regeneratorRuntime.mark(function t(n, r) {
                  var o;
                        ...
                        switch ((t.prev = t.next)) {
                          ...
                          case 5:
                            return (
                              (o = t.sent),
                              (this.animator = new i(
                                new e.GifReader(new Uint8Array(o))
                              )),
                              this.animator.animateInCanvas(r),
                              this.imageLoaded(),
                              (this.loaded = !0),
                              t.abrupt("return", this.animator)
                            );
                          case 13:
                            (t.prev = 13),
                              (t.t0 = t.catch(2)),
                              this.imageError(t.t0);
                          case 16:
                            this.loading = !1;
                          case 17:
                          case "end":
            ...
            { key: "imageLoading", value: function () {} },
            { key: "imageLoaded", value: function () {} },
            { key: "imageError", value: function (t) {} },
            {
              key: "_xhr",
              value: function (t) {
    ...
    window.$docsify || (window.$docsify = {}),
      ...
      (window.$docsify.plugins = [].concat(function (t, n) {
        t.doneEach(function (t) {
          var r = Array.apply(
              null,
              document.querySelectorAll(
                ".markdown-section img:not(.emoji):not([data-gifcontrol-disabled])"
              )
            ),
            e = r.filter(function (t) {
              return (
                t.src.includes(".gif") &&
                !t.title.includes("-gifcontrol-disabled")
              );
            });
          (e = e.filter(function (t) {
            ...
            o.classList.add("gifcontrol-canvas"),
              o.classList.add("gifcontrol-loading"),
              (o.style.fill = e.iconColor),
              (o.style.stroke = e.iconColor),
              (o.style.width = e.loadingWidth),
              (o.style.height = e.loadingHeight),
              (o.style.maxWidth = "100%"),
              "click" === e.mode && (o.style.cursor = "pointer");
            var i = document.createElement("div");
            i.classList.add("gifcontrol-loading-element"),
              (i.style.backgroundColor = e.overlayColor);
            var a = document.createElement("div");
            a.classList.add("gifcontrol-loading-spinner"),
              (a.style.borderColor = e.spinnerTrackColor),
              (a.style.borderTopColor = e.spinnerBarColor),
              i.appendChild(a);
            var u = document.createElement("div");
            u.classList.add("gifcontrol-controls-element"),
              (u.style.backgroundColor = e.overlayColor),
              (u.innerHTML = e.playIcon);
            var s = document.createElement("div");
            (s.style.backgroundColor = e.overlayColor),
              s.classList.add("gifcontrol-error-element"),
              (s.style.color = e.errorTextColor),
              (s.innerHTML = ""
                .concat(e.errorIcon, ' <div class="gifcontrol-errortext">')
                .concat(e.errorText, "</div>"));
            ...
            (p.imageLoaded = function () {
              o.classList.remove("gifcontrol-loading"),
                o.classList.add("gifcontrol-success"),
                (o.style.width = p.animator.width),
                (o.style.height = "auto");
            }),
              (p.imageError = function (t) {
                o.classList.remove("gifcontrol-loading"),
                  o.classList.add("gifcontrol-error");
              }),
              p.load(r, h),
              (o.onmouseenter = function () {
                p.loaded &&
                  "click" !== e.mode &&
                  (o.classList.add("gifcontrol-playing"), p.animator.start());
              }),
              (o.onmouseleave = function () {
                p.loaded &&
                  "click" !== e.mode &&
                  (o.classList.remove("gifcontrol-playing"), p.animator.stop());
              }),
              (o.onclick = function () {
                p.loaded &&
                  "click" === e.mode &&
                  (p.animator.running
                    ? (o.classList.remove("gifcontrol-playing"),
                      p.animator.stop())
                    : (o.classList.add("gifcontrol-playing"),
                      p.animator.start()));
              });
          }),
            r
