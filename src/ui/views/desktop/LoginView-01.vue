  ...
  <div class="login-body unselect">
    <div class="login-box">
      ...
      <el-form style="width: 100%">
        <el-input :placeholder="$t('loginView.inputAccount')" v-model="username" show-password></el-input>
...
import { request_user_login } from '@/api/userLogin'
...
const username = ref('blue_sugar')
const password = ref('blue123@')
