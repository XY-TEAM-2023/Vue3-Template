<template>
          ...
          <div class="label-holder">
            <el-form class="inline-form">
              <el-row :gutter="20">
                ...
                <el-col :xs="24" :sm="12" :md="4">
                  <el-form-item :label="$t('FIListView.SmsType')">
                ...
                <el-col :xs="24" :sm="12" :md="4">
                  <el-form-item :label="$t('FIListView.Name')">
                    <el-input v-model="filterId" placeholder=""></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="4">
                  <el-form-item :label="$t('FIListView.Amount')">
                    <el-input v-model="filterId" placeholder=""></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="4">
  ...
  <el-card style="margin-top: 5px">
    ...
    >
      ...
      <el-table-column prop="role_id" width="130px" align="center" :label="$t('FIListView.SmsType')" />
      <el-table-column prop="account" align="center" :label="$t('FIListView.DWType')" />
      <el-table-column prop="role_id" align="center" :label="$t('FIListView.Sms')" />
      <el-table-column prop="account" align="center" :label="$t('FIListView.SmsTime')" />
      <el-table-column prop="role_id" align="center" :label="$t('FIListView.Name')" />
      <el-table-column prop="role_id" align="center" :label="$t('FIListView.Amount')" />
      <el-table-column prop="role_id" align="center" :label="$t('FIListView.Type')" />
    </el-table-ex>
  </el-card>
</template>
