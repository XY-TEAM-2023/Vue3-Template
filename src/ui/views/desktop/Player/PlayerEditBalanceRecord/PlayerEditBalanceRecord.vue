<template>
      ...
      <el-row :gutter="24">
        <el-col :lg="4" :md="8" :sm="12" :xs="24">
          <el-form-item-select-local
            label="PlayerEditBalanceRecord.brand"
        ...
        <el-col :lg="4" :md="8" :sm="12" :xs="24">
          <el-form-item-integer
            label="PlayerEditBalanceRecord.playerID"
        ...
        <el-col :lg="4" :md="8" :sm="12" :xs="24">
          <el-form-item-label
            label="PlayerEditBalanceRecord.playerAccount"
        ...
        <el-col :lg="4" :md="8" :sm="12" :xs="24">
          <el-form-item-label
            label="PlayerEditBalanceRecord.operator"
            v-model="searchData.search_operator"
            prop="search_operator"
            :placeholder="null"
            :maxlength="null"
            clearable
          />
  ...
  <el-card-ex :use-fold="false" shadow="never" style="margin-top: 10px">
    ...
    >
      ...
      <el-table-column-integer label="PlayerEditBalanceRecord.recordId" prop="id" align="center" />
      <el-table-column-label label="PlayerEditBalanceRecord.brand" prop="brand" align="center" />
      <el-table-column-integer label="PlayerEditBalanceRecord.playerID" prop="player_id" align="center" />
      <el-table-column-label label="PlayerEditBalanceRecord.playerAccount" prop="account" align="center" />
      <el-table-column-money label="PlayerEditBalanceRecord.editAmount" prop="amount" align="center" />
      <el-table-column-money label="PlayerEditBalanceRecord.editBeforeAmount" prop="before_balance" align="center" />
      <el-table-column-money label="PlayerEditBalanceRecord.editAfterAmount" prop="new_balance" align="center" />
      <el-table-column-label label="PlayerEditBalanceRecord.operator" prop="operator" align="center" />
      <el-table-column-timestamp label="PlayerEditBalanceRecord.editTime" prop="ts" align="center" />
    </el-table-ex>
  </el-card-ex>
</template>
...
const searchPageData = ref({
  page: 1,
  page_size: getDefaultPageSize('/api/admin/player/record/edit/balance'),
  total: 0,
})
...
function requestSearch() {
  ...
  http_post('/api/admin/player/record/edit/balance', { ...searchData.value, ...searchPageData.value }, false)
    .then((response) => {
